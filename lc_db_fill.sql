insert into lc_shop (id, name, description, maxcashback, url, logourl)
values
(1, 'Best Shop Ever', 'От диванов до пельменей', 5, '/bse', '/img/bse_logo.svg');

insert into bse_product (name, pictureurl, price, cashbackpercent)
values
